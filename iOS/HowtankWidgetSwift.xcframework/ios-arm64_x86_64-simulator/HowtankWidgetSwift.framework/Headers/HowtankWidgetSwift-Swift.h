...
#ifndef HOWTANKWIDGETSWIFT_SWIFT_H
#define HOWTANKWIDGETSWIFT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HowtankWidgetSwift",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18HowtankWidgetSwift9ColorItem")
@interface ColorItem : NSObject
- (nonnull instancetype)initWithType:(enum ColorType)type color:(UIColor * _Nonnull)color OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC18HowtankWidgetSwift18ExpandedWidgetView")
@interface ExpandedWidgetView : UIView <UICollectionViewDataSource, UICollectionViewDelegate, UITextViewDelegate>
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified sendTextButton;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified moreActionsButton;
- (void)awakeFromNib;
...
- (void)configThemeWithTheme:(Theme * _Nonnull)theme;
...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (nonnull instancetype)initWithOptions:(NSArray<ColorItem *> * _Nonnull)options OBJC_DESIGNATED_INITIALIZER;
@end

typedef SWIFT_ENUM(NSInteger, ColorType, open) {
  ColorTypeTheme = 0,
  ColorTypeActive = 1,
  ColorTypeThemeText = 2,
  ColorTypeActiveText = 3,
  ColorTypeBubbleActive = 4,
  ColorTypeBubbleActiveText = 5,
  ColorTypeBubbleInactive = 6,
  ColorTypeBubbleInactiveText = 7,
  ColorTypeUserChat = 8,
  ColorTypeDistantChat = 9,
  ColorTypeUserChatText = 10,
  ColorTypeDistantChatText = 11,
  ColorTypeUserWritingView = 12,
  ColorTypeDistantWritingView = 13,
  ColorTypeIntroText = 14,
  ColorTypeIntroBackground = 15,
  ColorTypeDisclaimerText = 16,
  ColorTypeLink = 17,
  ColorTypeLinkBackground = 18,
  ColorTypeBackground = 19,
  ColorTypeTitle = 20,
  ColorTypeSubtitle = 21,
  ColorTypeThumb = 22,
  ColorTypeInactive = 23,
  ColorTypeTabs = 24,
  ColorTypeHeader = 25,
};
...
SWIFT_CLASS("_TtC18HowtankWidgetSwift4User")
